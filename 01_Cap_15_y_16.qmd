...
## Número de UPMs en el traslape   {.smaller}
...
## Creación de los pesos longitudinales {.smaller}
...
## Ausencia de respuesta y atrición {.smaller}
...
## Asignación de peso nulo a los no respondientes {.smaller}
...
## Ajuste por respuesta en segundo periodo {.smaller}
...
## Peso longitudinal ajustado {.smaller}
...
## Calibración de los pesos longitudinales {.smaller}
...
## Restricción de calibración {.smaller}
...
## Forma funcional del peso calibrado {.smaller}
...
## Consideraciones adicionales {.smaller}
...
### Paso 8: Definir totales poblacionales conocidos {.smaller}
...
### Paso 9: Crear diseño muestral con pesos ajustados {.smaller}
...
### Paso 10: Ajuste por calibración por área y sexo {.smaller}
...
### Validación de la calibración {.smaller}
...
### Paso final: Asignar pesos calibrados a la base {.smaller}
